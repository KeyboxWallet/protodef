...
typedef enum _BtcLikeCoins {
    BtcLikeCoins_BITCOIN = 0,
    BtcLikeCoins_LITECOIN = 1,
    BtcLikeCoins_DASH = 2,
    BtcLikeCoins_BITCOINCASH = 3
} BtcLikeCoins;
#define _BtcLikeCoins_MIN BtcLikeCoins_BITCOIN
#define _BtcLikeCoins_MAX BtcLikeCoins_BITCOINCASH
#define _BtcLikeCoins_ARRAYSIZE ((BtcLikeCoins)(BtcLikeCoins_BITCOINCASH+1))
...
typedef PB_BYTES_ARRAY_T(8192) EthereumSignRequest_unsignedTx_t;
typedef struct _EthereumSignRequest {
    char hdPath[512];
    EthereumSignRequest_unsignedTx_t unsignedTx;
/* @@protoc_insertion_point(struct:EthereumSignRequest) */
} EthereumSignRequest;

typedef PB_BYTES_ARRAY_T(8192) EthereumSignResult_signedTx_t;
typedef struct _EthereumSignResult {
    EthereumSignResult_signedTx_t signedTx;
/* @@protoc_insertion_point(struct:EthereumSignResult) */
} EthereumSignResult;
...
#define BitcoinSignRequest_init_default          {0, {0, {0}}, _BtcLikeCoins_MIN}
#define BitcoinSignResult_init_default           {{0, {0}}}
#define EthereumSignRequest_init_default         {"", {0, {0}}}
#define EthereumSignResult_init_default          {{0, {0}}}
...
#define BitcoinSignRequest_init_zero             {0, {0, {0}}, _BtcLikeCoins_MIN}
#define BitcoinSignResult_init_zero              {{0, {0}}}
#define EthereumSignRequest_init_zero            {"", {0, {0}}}
#define EthereumSignResult_init_zero             {{0, {0}}}

/* Field tags (for use in manual encoding/decoding) */
#define BitcoinSignRequest_testnet_tag           1
#define BitcoinSignRequest_psbt_tag              2
#define BitcoinSignRequest_coin_tag              3
...
#define EthereumSignRequest_hdPath_tag           1
#define EthereumSignRequest_unsignedTx_tag       2
#define EthereumSignResult_signedTx_tag          1
...
extern const pb_field_t BitcoinSignRequest_fields[4];
extern const pb_field_t BitcoinSignResult_fields[2];
extern const pb_field_t EthereumSignRequest_fields[3];
extern const pb_field_t EthereumSignResult_fields[2];
...
#define BitcoinSignRequest_size                  8199
#define BitcoinSignResult_size                   8195
#define EthereumSignRequest_size                 8710
#define EthereumSignResult_size                  8195
