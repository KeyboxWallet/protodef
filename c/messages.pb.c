...
/* Generated by nanopb-0.3.9.1 at Mon Jul 13 18:11:35 2020. */
...
const pb_field_t GetWalletIdentifierRequest_fields[1] = {
    PB_LAST_FIELD
};

const pb_field_t GetWalletIdentifierReply_fields[2] = {
    PB_FIELD(  1, BYTES   , SINGULAR, STATIC  , FIRST, GetWalletIdentifierReply, bip32MasterKeyId, bip32MasterKeyId, 0),
    PB_LAST_FIELD
};
...
const pb_field_t BitcoinSignRequest_fields[4] = {
    PB_FIELD(  1, BOOL    , SINGULAR, STATIC  , FIRST, BitcoinSignRequest, testnet, testnet, 0),
    PB_FIELD(  2, BYTES   , SINGULAR, STATIC  , OTHER, BitcoinSignRequest, psbt, testnet, 0),
    PB_FIELD(  3, UENUM   , SINGULAR, STATIC  , OTHER, BitcoinSignRequest, coin, psbt, 0),
    PB_LAST_FIELD
};

const pb_field_t BitcoinSignResult_fields[2] = {
    PB_FIELD(  1, BYTES   , SINGULAR, STATIC  , FIRST, BitcoinSignResult, psbt, psbt, 0),
    PB_LAST_FIELD
};

const pb_field_t EthereumSignRequest_fields[3] = {
    PB_FIELD(  1, STRING  , SINGULAR, STATIC  , FIRST, EthereumSignRequest, hdPath, hdPath, 0),
    PB_FIELD(  2, BYTES   , SINGULAR, STATIC  , OTHER, EthereumSignRequest, unsignedTx, hdPath, 0),
    PB_LAST_FIELD
};

const pb_field_t EthereumSignResult_fields[2] = {
    PB_FIELD(  1, BYTES   , SINGULAR, STATIC  , FIRST, EthereumSignResult, signedTx, signedTx, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(UpgradeStartRequest, sha256hash) < 65536 && pb_membersize(SendUpgradeFirmware, sha256hash) < 65536 && pb_membersize(EccSignRequest, hash) < 65536 && pb_membersize(EccSignRequest, options) < 65536 && pb_membersize(EccSignResult, pubkey) < 65536 && pb_membersize(EccSignResult, hash) < 65536 && pb_membersize(EccSignResult, R) < 65536 && pb_membersize(EccSignResult, S) < 65536 && pb_membersize(EccGetPublicKeyReply, pubkey) < 65536 && pb_membersize(EccGetExtendedPublicKeyReply, pubkey) < 65536 && pb_membersize(EccGetExtendedPublicKeyReply, chainCode) < 65536 && pb_membersize(EccMultiplyRequest, input_pubkey) < 65536 && pb_membersize(EccMultiplyReply, input_pubkey) < 65536 && pb_membersize(EccMultiplyReply, dev_pubkey) < 65536 && pb_membersize(EccMultiplyReply, result) < 65536 && pb_membersize(BitcoinSignRequest, psbt) < 65536 && pb_membersize(BitcoinSignResult, psbt) < 65536 && pb_membersize(EthereumSignRequest, unsignedTx) < 65536 && pb_membersize(EthereumSignResult, signedTx) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_RequestRejected_GenericConfirmReply_GetModeAndVersionRequest_GetModeAndVersionReply_UpgradeStartRequest_SendUpgradeFirmware_WriteSerialNo_WriteSerialNoReply_LockSerialNo_lockSerialNoReply_EccSignOptions_EccSignRequest_EccSignResult_EccGetPublicKeyRequest_EccGetPublicKeyReply_EccGetExtendedPublicKeyRequest_EccGetExtendedPublicKeyReply_GetWalletIdentifierRequest_GetWalletIdentifierReply_EccMultiplyRequest_EccMultiplyReply_EraseDataRequest_BitcoinSignRequest_BitcoinSignResult_EthereumSignRequest_EthereumSignResult)
#endif

#if !defined(PB_FIELD_16BIT) && !defined(PB_FIELD_32BIT)
#error Field descriptor for EthereumSignResult.signedTx is too large. Define PB_FIELD_16BIT to fix this.
#endif
