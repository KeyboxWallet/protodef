 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(UpgradeStartRequest, sha256hash) < 65536 && pb_membersize(SendUpgradeFirmware, sha256hash) < 65536 && pb_membersize(EccSignRequest, hash) < 65536 && pb_membersize(EccSignRequest, options) < 65536 && pb_membersize(EccSignResult, pubkey) < 65536 && pb_membersize(EccSignResult, hash) < 65536 && pb_membersize(EccSignResult, R) < 65536 && pb_membersize(EccSignResult, S) < 65536 && pb_membersize(EccGetPublicKeyReply, pubkey) < 65536 && pb_membersize(EccGetExtendedPublicKeyReply, pubkey) < 65536 && pb_membersize(EccGetExtendedPublicKeyReply, chainCode) < 65536 && pb_membersize(EccMultiplyRequest, input_pubkey) < 65536 && pb_membersize(EccMultiplyReply, input_pubkey) < 65536 && pb_membersize(EccMultiplyReply, dev_pubkey) < 65536 && pb_membersize(EccMultiplyReply, result) < 65536 && pb_membersize(BitcoinSignRequest, psbt) < 65536 && pb_membersize(BitcoinSignResult, psbt) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_RequestRejected_GenericConfirmReply_GetModeAndVersionRequest_GetModeAndVersionReply_UpgradeStartRequest_SendUpgradeFirmware_WriteSerialNo_WriteSerialNoReply_LockSerialNo_lockSerialNoReply_EccSignOptions_EccSignRequest_EccSignResult_EccGetPublicKeyRequest_EccGetPublicKeyReply_EccGetExtendedPublicKeyRequest_EccGetExtendedPublicKeyReply_GetWalletIdentifierRequest_GetWalletIdentifierReply_EccMultiplyRequest_EccMultiplyReply_EraseDataRequest_BitcoinSignRequest_BitcoinSignResult)
#endif

#if !defined(PB_FIELD_16BIT) && !defined(PB_FIELD_32BIT)
#error Field descriptor for BitcoinSignResult.psbt is too large. Define PB_FIELD_16BIT to fix this.
#endif
