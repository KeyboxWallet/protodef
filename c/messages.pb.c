...
const pb_field_t GetModeAndVersionReply_fields[4] = {
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(UpgradeStartRequest, sha256hash) < 65536 && pb_membersize(SendUpgradeFirmware, sha256hash) < 65536 && pb_membersize(EccSignRequest, hash) < 65536 && pb_membersize(EccSignRequest, options) < 65536 && pb_membersize(EccSignResult, pubkey) < 65536 && pb_membersize(EccSignResult, hash) < 65536 && pb_membersize(EccSignResult, R) < 65536 && pb_membersize(EccSignResult, S) < 65536 && pb_membersize(EccGetPublicKeyReply, pubkey) < 65536 && pb_membersize(EccMultiplyRequest, input_pubkey) < 65536 && pb_membersize(EccMultiplyReply, input_pubkey) < 65536 && pb_membersize(EccMultiplyReply, dev_pubkey) < 65536 && pb_membersize(EccMultiplyReply, result) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_RequestRejected_GenericConfirmReply_GetModeAndVersionRequest_GetModeAndVersionReply_UpgradeStartRequest_SendUpgradeFirmware_WriteSerialNo_WriteSerialNoReply_LockSerialNo_lockSerialNoReply_EccSignOptions_EccSignRequest_EccSignResult_EccGetPublicKeyRequest_EccGetPublicKeyReply_EccMultiplyRequest_EccMultiplyReply_EraseDataRequest)
#endif
